...
<div id="main-wrapper">
    ...
    <aside class="left-sidebar">
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li class="user-profile"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><img src="{{asset('admin/assets/images/users/profile.png')}}" alt="user" /><span class="hide-menu"> Jesús Gonzalez </span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="javascript:void()">Mi perfil </a></li>
                            <li><a href="javascript:void()">Pedidos</a></li>
                            <li><a href="javascript:void()">Clientes</a></li>
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-map-marker"></i><span class="hide-menu">Centros ecoturisticos</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{asset('admin/centros_ecoturisticos/socio')}}">Socios</a></li>
                            <li><a href="{{asset('admin/centros_ecoturisticos/colaborador')}}">Colaboradores</a></li>
                        </ul>
                    </li>
    ...
    <div class="page-wrapper">
        ...
        <footer class="footer"> © {{now()->format('Y')}} SENDASUR </footer>
