         ...
         <div class="card m-3">
            ...
            <div class="card-body">
               ...
               <p class="card-text text-center"> Todos nuestros paquetes, pueden incluir todos los alimentos o
                  pueden ser sin comida, dependiendo lo que el cliente desea que incluya en su paquete. 
               </p>
            </div>
         </div>
         <div class="card m-3">
            ...
            <div class="card-body">
               ...
               <p class="card-text text-center"> Podrás visitar el Estado de Chiapas de una manera más auténtica y
                  mágica, sin prisas, sin presiones, sin itinerarios apretados. 
               </p>
            </div>
         </div>
         <div class="card m-3">
            ...
            <div class="card-body">
               ...
               <p class="card-text text-center"> Para ofrecer un mejor servicio y apoyar a la economía local, contratamos a guías comunitarios en
                  cada lugar turístico que visitamos y en las zonas arqueológicas. 
               </p>
            </div>
         </div>
      </div>
